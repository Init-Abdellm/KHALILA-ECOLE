      ...
      <main className="pt-20">
        ...
        <section className="py-16 bg-neutral-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Event preview cards will be dynamically populated */}
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div
              ...
              className="bg-neutral-50 p-6 rounded-lg shadow-lg"
            >
              <SubscriptionForm />
            </motion.div>
          </div>
      ...
      <footer className="bg-neutral-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-neutral-400">
                <li><Link to="/login" className="hover:text-primary transition-colors">Espace Connecté</Link></li>
          ...
          <div className="mt-8 pt-8 border-t border-neutral-800 text-center text-neutral-400">
            <p>&copy; 2024 École Khalilia. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>
